...
// include: C:\Dev\runtime\artifacts\bin\native\net10.0-browser-Debug-wasm\src\es6\dotnet.es6.pre.js
...
// end include: C:\Dev\runtime\artifacts\bin\native\net10.0-browser-Debug-wasm\src\es6\dotnet.es6.pre.js
...
// end include: preamble.js
  ...
  function _mono_wasm_profiler_now(
  ) {
  return {runtime_idx:15};//mono_wasm_profiler_now
  }

  function _mono_wasm_profiler_record(
  ) {
  return {runtime_idx:16};//mono_wasm_profiler_record
  }
...
var wasmImports = {
  ...
  /** @export */
  mono_wasm_profiler_now: _mono_wasm_profiler_now,
  /** @export */
  mono_wasm_profiler_record: _mono_wasm_profiler_record,
  /** @export */
...
var _mono_wasm_profiler_init_log = Module['_mono_wasm_profiler_init_log'] = createExportWrapper('mono_wasm_profiler_init_log');
